...
goog.require('shaka.dash.MssRequest');
...
shaka.player.DashVideoSource.prototype.load = function(preferredLanguage) {
  ...
  var convertMss = this.mpdUrl_.indexOf('ism/Manifest') > 0;
  var requestClass = convertMss ? shaka.dash.MssRequest : shaka.dash.MpdRequest;
  var mpdRequest = new requestClass(this.mpdUrl_);
