...
shaka.media.SourceBufferManager.prototype.append_ = function(data) {
  ...
  try {
    ...
    var converted = shaka.dash.mss.baseUrl ? uux.convertFragment(new Uint8Array(data), null, false) : new Uint8Array(data);
    console.log(btoa(converted));
    this.sourceBuffer_.appendBuffer(converted.buffer);
  } catch (exception) {
